...
import { SeatComparisonDisplay, ScrapedSeatDisplay } from '@/components/SeatRecommendation';
...
export default function SeatmapPageContent() {
  ...
  const iframeLoadState = useIframeLoadState(iframeElement);
  ...
  }, [seatRecommendation.result, iframeLoadState.isReady, iframeSeatScraping.loading]);
          ...
          <div className="flex-1 overflow-y-auto p-4">
            <div className="h-full">
              {seatRecommendation.result ? (
                ...
                <SeatComparisonDisplay 
                  // @ts-expect-error result is not available during loading state; component handles loading UI
                  result={undefined}
                  loading={true}
                  error={null}
                  className="h-full"
                ...
                <SeatComparisonDisplay 
                  // @ts-expect-error result is not available when error; component handles error UI
                  result={undefined}
                  loading={false}
                  error={seatRecommendation.error}
                  className="h-full"
