      ...
      <div className="flex items-center justify-center min-h-screen px-4">
        <div className="w-full max-w-4xl my-20">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Scenic Sky Flight Planner</h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Plan and visualize great-circle flight paths between major airports. Experience smooth flight animations on an interactive satellite map.
            </p>
          </div>
          ...
          {errorMessage && (
            <div className="mt-6 p-4 bg-red-50 border border-red-200 rounded-lg text-red-700 text-center">{errorMessage}</div>
          )}
